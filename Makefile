...
clean:
	rm -rf coalesce_test composition_test complement_test tiling_test *.dSYM product_test identity_test layout_algtest divide_test inverse_test 01_mma_sm100_test
