...
int main() {
  ...
  auto t_g_in  = make_tensor(make_gmem_ptr((uint16_t *)0), smem_layout);
  auto t_g_out = make_tensor(make_gmem_ptr((uint16_t *)0), smem_layout);
  auto t_smem  = make_tensor(make_smem_ptr((uint16_t *)0), smem_layout);
